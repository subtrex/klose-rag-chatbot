...
class ChatBot():
  ...
  template = """
  You are a time management, task management, and productivity expert. Users will ask you questions about time management, 
  productivity tips, and how to manage their tasks well. Use the following piece of context to answer the question.
